...
//  Updated on 05/11/25 - Enhanced error handling with comprehensive cases
//

import Foundation

/// Enum định nghĩa tất cả các loại lỗi có thể xảy ra trong network layer
///
/// # Overview
/// APIError provide type-safe error handling với detailed information về
/// từng loại lỗi network. Mỗi error case có localized Vietnamese message.
///
/// # Categories
/// - **Client Errors**: invalidURL, invalidResponse, decodingError
/// - **Network Errors**: networkError, timeout, noInternetConnection, requestCancelled
/// - **Server Errors**: unauthorized, forbidden, notFound, serverError, etc.
/// - **Application Errors**: tokenRefreshFailed, noData
///
/// # Usage
/// ```swift
/// do {
...
/// ```
///
/// - Note: All error cases have Vietnamese localized descriptions
/// - SeeAlso: `NetworkManager` for error handling flow
